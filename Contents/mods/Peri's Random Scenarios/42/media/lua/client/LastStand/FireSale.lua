...
--direstart = false; 
		...
		if getPlayer():getHoursSurvived()<=1 then
			...
			pl:getStats():set(CharacterStat.THIRST, 0.15 + pillowmod.statmod); -- from 0 to 1
			pl:getStats():set(CharacterStat.HUNGER, 0.15 + pillowmod.statmod); -- from 0 to 1
			pl:getStats():set(CharacterStat.FATIGUE, 0.25 + pillowmod.statmod); -- from 0 to 1
